...
function layDanhSachPokemon() 
	{
		...
		$
				.ajax({
					type : "GET",
					url : "http://localhost:8080/PokemonDatabase/dexAlls",
					dataType : "json",
								...
								.each(
										...
										function(index, pkm) {
											if(pkm.type2>0) {
												...
												thongtin += "<td class='cell-num cell-fixed' data-sort-value='1'><span class='infocard-cell-img'><img class='img-fixed icon-pkmn' src='http://localhost:8080/PokemonDatabase/images/icon/"
...
function timKiem(pkmname,type){
	$.ajax({
		type: "GET",
		url: "http://localhost:8080/PokemonDatabase/dexSearch/"+ pkmname +"&" + type,
		dataType : "json",
		contentType : "application/json; charset=utf-8",
		async : true,
		traditional : true,
...
<main id="main" class="main-content grid-container">
        ...
        <div class="panel panel-intro">
            <p>This is a full list of <em>every Pokémon</em> from all 8 generations of the Pokémon series, along with
                their main stats.</p>
