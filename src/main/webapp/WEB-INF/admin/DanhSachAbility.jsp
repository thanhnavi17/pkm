	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1 class="pageModule" data-module="dsAbility">Ability</h1>
					</div>
					<div class="col-sm-6">
										...
										<c:if test="${not empty lstAbi }">
											<c:forEach var="abi" items="${lstAbi }">
												<tr>
													...
													<td><a class="btnSua" style="display:none;" href="${abiUpd }/${abi.id}">Sửa</a> <a
														onclick="return confirm('Bạn có chắn chắn muốn xoá pokemon này không ?');"
														href="${abiDel}/${abi.id}" class="btnXoa" style="display:none;">Xoá</a></td>
												</tr>
											</c:forEach>
										</c:if>
									</tbody>
