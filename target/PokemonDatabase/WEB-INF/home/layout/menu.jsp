		...
		<ul class="main-menu-list">
			<li class="main-menu-item"><a class="main-menu-heading"
				href="/sitemap"> <svg xmlns="http://www.w3.org/2000/svg"
					...
					class="main-menu-title-long">Pokémon data</span>
			</a>
				<ul class="main-menu-sub">
					...
					<li><a href="/pokedex/game/ultra-sun-ultra-moon">Ultra Sun
							&amp; Ultra Moon Pokédex</a></li>
					<li><a href="/pokedex/game/lets-go-pikachu-eevee">Let's Go
							Pikachu/Eevee Pokédex</a></li>
					<li><a href="/pokedex/game/sword-shield">Sword &amp;
							Shield Pokédex</a></li>
				</ul></li>
			<li class="main-menu-item"><a class="main-menu-heading"
				href="/sitemap"> <svg xmlns="http://www.w3.org/2000/svg"
					...
					class="main-menu-title-long">Game mechanics</span>
			</a>
				<ul class="main-menu-sub">
			...
			<li class="main-menu-item"><a class="main-menu-heading"
				href="/sitemap"> <svg xmlns="http://www.w3.org/2000/svg"
					...
					class="main-menu-title-long">Pokémon games</span>
			</a>
				<ul class="main-menu-sub">
					<li><a href="/sword-shield">Sword &amp; Shield</a></li>
					<li class="main-menu-hr"></li>
					<li><a href="/lets-go-pikachu-eevee">Let's Go Pikachu
							&amp; Let's Go Eevee</a></li>
					<li><a href="/ultra-sun-ultra-moon">Ultra Sun &amp; Ultra
							Moon</a></li>
					<li><a href="/sun-moon">Sun &amp; Moon</a></li>
					<li class="main-menu-hr"></li>
					<li><a href="/omega-ruby-alpha-sapphire">Omega Ruby &amp;
							Alpha Sapphire</a></li>
					...
					<li class="main-menu-hr"></li>
					<li><a href="/heartgold-soulsilver">HeartGold &amp;
							SoulSilver</a></li>
			...
			<li class="main-menu-item"><a class="main-menu-heading"
				href="/sitemap"> <svg xmlns="http://www.w3.org/2000/svg"
					...
					class="main-menu-title-long">Community/Other</span>
			</a>
				<ul class="main-menu-sub">
